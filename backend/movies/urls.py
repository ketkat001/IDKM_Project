...
from .views import MovieListAPI, MovieDetailAPI, MoviesearchAPI, MoviedibAPI, MovielikeAPI, MoviewatchedAPI, MoviesearchAPI
...
urlpatterns = [
    ...
    path('recommend/<int:user_pk>/', MoviesearchAPI.as_view()),
